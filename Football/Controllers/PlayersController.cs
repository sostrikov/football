...
namespace Football.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Age,Position,TeamId")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Age,Position,TeamId")] Player player)
        {
            if (ModelState.IsValid)
            {
